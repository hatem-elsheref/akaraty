...
@section('bread')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Add New Land</li>
    </ol>
@endsection
@section('css_before')
    <!-- Select2 -->
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add New Land</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="post" action="{{route('real-estate.store_land')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-12">
